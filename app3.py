...
with st.sidebar:
    ...
    """, unsafe_allow_html=True)
    st.markdown("---")
    page = st.radio("", ["🏠  Home","📤  Upload & Analyze","📊  Dashboard","👤  Candidate Detail","📄  Report","👥  Our Team"])
    st.markdown("---")
...
if page == "👥  Our Team":
    ...
    <div style='
        ...
        box-shadow: 0 0 60px rgba(102,126,234,0.12), inset 0 1px 0 rgba(255,255,255,0.05);
    '>
        <div style='font-size:70px; margin-bottom:14px; filter:drop-shadow(0 0 20px #667eea);'>👥</div>
        <h1 style='
            font-size:48px; font-weight:900; margin:0 0 10px 0;
            background: linear-gradient(135deg, #a78bfa 0%, #667eea 40%, #f093fb 100%);
            -webkit-background-clip:text; -webkit-text-fill-color:transparent;
        '>Meet The Team</h1>
        <p style='color:rgba(255,255,255,0.35); font-size:13px; letter-spacing:2px; text-transform:uppercase; margin:0;'>
            The Minds Behind HireRight AI
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("<div style='background:rgba(255,255,255,0.02);border:1px solid rgba(102,126,234,0.2);border-radius:16px;padding:24px 20px;margin-bottom:24px;overflow-x:auto;'><div style='display:flex;align-items:center;gap:6px;flex-wrap:nowrap;min-width:max-content;'><div style='background:#667eea;border-radius:14px;padding:18px 14px;text-align:center;min-width:82px;box-shadow:0 4px 18px #667eea55;'><div style='font-size:26px;margin-bottom:6px;'>📥</div><div style='color:#fff;font-size:11px;font-weight:700;'>Resume Input</div></div><div style='color:#555;font-size:20px;padding:0 4px;'>❯</div><div style='background:#a855f7;border-radius:14px;padding:18px 14px;text-align:center;min-width:82px;box-shadow:0 4px 18px #a855f755;'><div style='font-size:26px;margin-bottom:6px;'>🔍</div><div style='color:#fff;font-size:11px;font-weight:700;'>Text Extract</div></div><div style='color:#555;font-size:20px;padding:0 4px;'>❯</div><div style='background:#f97316;border-radius:14px;padding:18px 14px;text-align:center;min-width:82px;box-shadow:0 4px 18px #f9731655;'><div style='font-size:26px;margin-bottom:6px;'>📋</div><div style='color:#fff;font-size:11px;font-weight:700;'>Resume Parse</div></div><div style='color:#555;font-size:20px;padding:0 4px;'>❯</div><div style='background:#06b6d4;border-radius:14px;padding:18px 14px;text-align:center;min-width:82px;box-shadow:0 4px 18px #06b6d455;'><div style='font-size:26px;margin-bottom:6px;'>🗄️</div><div style='color:#fff;font-size:11px;font-weight:700;'>Data Store</div></div><div style='color:#555;font-size:20px;padding:0 4px;'>❯</div><div style='background:#ec4899;border-radius:14px;padding:18px 14px;text-align:center;min-width:82px;box-shadow:0 4px 18px #ec489955;'><div style='font-size:26px;margin-bottom:6px;'>🧠</div><div style='color:#fff;font-size:11px;font-weight:700;'>RoBERTa Embed</div></div><div style='color:#555;font-size:20px;padding:0 4px;'>❯</div><div style='background:#64748b;border-radius:14px;padding:18px 14px;text-align:center;min-width:82px;box-shadow:0 4px 18px #64748b55;'><div style='font-size:26px;margin-bottom:6px;'>📐</div><div style='color:#fff;font-size:11px;font-weight:700;'>Cosine Sim</div></div><div style='color:#555;font-size:20px;padding:0 4px;'>❯</div><div style='background:#ef4444;border-radius:14px;padding:18px 14px;text-align:center;min-width:82px;box-shadow:0 4px 18px #ef444455;'><div style='font-size:26px;margin-bottom:6px;'>🎯</div><div style='color:#fff;font-size:11px;font-weight:700;'>LR Predict</div></div><div style='color:#555;font-size:20px;padding:0 4px;'>❯</div><div style='background:#3b82f6;border-radius:14px;padding:18px 14px;text-align:center;min-width:82px;box-shadow:0 4px 18px #3b82f655;'><div style='font-size:26px;margin-bottom:6px;'>📊</div><div style='color:#fff;font-size:11px;font-weight:700;'>Analytics</div></div><div style='color:#555;font-size:20px;padding:0 4px;'>❯</div><div style='background:#1e293b;border-radius:14px;padding:18px 14px;text-align:center;min-width:82px;box-shadow:0 4px 18px #1e293b55;border:1px solid rgba(102,126,234,0.3);'><div style='font-size:26px;margin-bottom:6px;'>📄</div><div style='color:#fff;font-size:11px;font-weight:700;'>PDF Report</div></div></div></div>", unsafe_allow_html=True)

    # ── Module Table ──────────────────────────────────────────
    st.markdown("<div class='section-header'>📦 Module Responsibilities</div>", unsafe_allow_html=True)

    modules = [
        ("Module 1", "#667eea", "Resume Collection & Input Layer",        "Md Furhan Pasha & Rakshith Krishna Murthy"),
        ("Module 2", "#22c55e", "Resume Parsing Module",                  "Md Furhan Pasha & Rakshith Krishna Murthy"),
        ("Module 3", "#f97316", "Structured Data Storage",                "Md Furhan Pasha & Rakshith Krishna Murthy"),
        ("Module 4", "#a855f7", "NLP Processing Module",                  "Ajith B & Seema N C"),
        ("Module 5", "#ec4899", "Feature Engineering",                    "Ajith B & Seema N C"),
        ("Module 6", "#06b6d4", "Similarity & Candidate Ranking Engine",  "Gokul Adithya"),
        ("Module 7", "#ef4444", "Suitability Prediction Model",           "Diya Dadheech"),
        ("Module 8", "#3b82f6", "Analytics & Visualization Dashboard",    "Disha S Reddy"),
        ("Module 9", "#78716c", "Automated Report Generation",            "Disha S Reddy"),
    ]

    for mod_no, color, mod_name, members in modules:
        st.markdown(f"""
        <div style='
        ...
        '>
            ...
            '>{mod_no}</div>
            <div style='flex:1; color:#c4b5fd; font-size:14px; font-weight:600;'>{mod_name}</div>
            <div style='color:#fbbf24; font-size:13px; font-weight:700; text-align:right;'>{members}</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    team = [
        {"name": "Md Furhan Pasha",        "email": "mdfurhanpasha@gmail.com",       "role": "Resume Collection, Parsing & Storage",  "modules": "Module 1, 2, 3",    "emoji": "📄", "color": "#22c55e"},
        {"name": "Rakshith Krishna Murthy","email": "rakr22aiml@cmrit.ac.in",        "role": "Resume Collection, Parsing & Storage",  "modules": "Module 1, 2, 3",    "emoji": "🛠️", "color": "#f97316"},
        {"name": "Ajith B",               "email": "ajithbalachandran911@gmail.com","role": "NLP Processing & Feature Engineering",  "modules": "Module 4, 5",       "emoji": "🧠", "color": "#a855f7"},
        {"name": "Seema N C",             "email": "ncseema5@gmail.com",             "role": "NLP Processing & Feature Engineering",  "modules": "Module 4, 5",       "emoji": "💡", "color": "#ec4899"},
        {"name": "Gokul Adithya",         "email": "gokuladithya71745@gmail.com",  "role": "Similarity & Ranking Engine",           "modules": "Module 6",          "emoji": "🚀", "color": "#667eea"},
        {"name": "Diya Dadheech",         "email": "diya05dadheech@gmail.com",       "role": "Suitability Prediction Model",          "modules": "Module 7",          "emoji": "🤖", "color": "#ef4444"},
        {"name": "Disha S Reddy",         "email": "dishareddy3704@gmail.com",       "role": "Analytics Dashboard & Report Gen",      "modules": "Module 8, 9",       "emoji": "📊", "color": "#3b82f6"},
    ]
    ...
    for i, member in enumerate(team):
        with cols[i % 2]:
            ...
            <div style='
                background: rgba(255,255,255,0.02);
                border: 1px solid rgba(255,255,255,0.06);
                border-top: 4px solid {member["color"]};
                border-radius: 16px;
                padding: 22px 20px;
                margin: 8px 0;
            ...
            '>
                <div style='display:flex; align-items:center; gap:14px; margin-bottom:12px;'>
                    ...
                    '>{member["emoji"]}</div>
                    <div>
                        <div style='color:#f5f5f5; font-size:15px; font-weight:800; margin-bottom:2px;'>{member["name"]}</div>
                        <div style='color:{member["color"]}; font-size:11px; font-weight:700; letter-spacing:0.5px;'>{member["modules"]}</div>
                    </div>
                </div>
                <div style='color:#a78bfa; font-size:12px; font-weight:600; margin-bottom:10px;'>🎯 {member["role"]}</div>
                <div style='
                    background:rgba(255,255,255,0.03); border:1px solid rgba(255,255,255,0.06);
                    border-radius:8px; padding:8px 12px;
                    color:#555; font-size:11px; word-break:break-all;
                '>✉️ {member["email"]}</div>
            </div>
            """, unsafe_allow_html=True)
